...
- **`services/`** – integrations with external APIs like Jellyfin, Navidrome, Last.fm, OpenAI and GetSongBPM.
...
2. External lookups (media server, Last.fm, GetSongBPM and OpenAI) are performed asynchronously using `httpx`.
